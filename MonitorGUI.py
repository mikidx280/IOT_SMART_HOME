...
class SubscribeDock(QDockWidget):
    ...
    def update_mess_win(self,text):
        ...
        flout_Humidity=int(string_Humidity[0])
        global b1
        global b2
        global b3
        ...
        if flout_temp>30:
            if(b1==0):
                ...
                self.mc.publish_to('pr/home/M&E_conditioner/sts', '"value":1')
                if(b2==0):
                    self.mc.publish_to('pr/home/M&E_alarm/sts', '"value":1')
        else:
            if(b1==1):
        ...
        if flout_Humidity==0:
            if(b2==0):
                b2=1
                b3=1
                self.eRecMess.append("Short circuit detected , turn on emergency generator")
                self.mc.publish_to('pr/home/mahyar_eliran_generator/sts', '"value":1')
                if(b1==0):
                    self.mc.publish_to('pr/home/M&E_alarm/sts', '"value":1')
        else:
            if(b2==1):
        ...
        if (flout_temp<=30) and (flout_Humidity==1):
            print(b3)
            print("222")
            if(b3==1):
                print("3333")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background-color:#23E57E")
