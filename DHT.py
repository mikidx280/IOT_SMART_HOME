...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("Voltage_220V",self.Humidity)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background-color:#F0BDB2")
    ...
    def update_data(self):
        ...
        hum=0+random.randrange(0,2)
        current_data='Temperature: '+str(temp)+' Voltage_220V: '+str(hum)
